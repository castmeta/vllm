...
class ModelConfig:
    ...
    mm_disk_cache_hash_prefix: InitVar[str | None] = None
    ...
    def __post_init__(
        ...
        mm_disk_cache_hash_prefix: str | None,
        ...
        if self._model_info.supports_multimodal:
            ...
            mm_config_kwargs = dict(
                ...
                mm_disk_cache_hash_prefix=mm_disk_cache_hash_prefix,
